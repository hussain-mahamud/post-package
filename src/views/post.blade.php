...
<html lang="en">
    <head>
        ...
        />
        <link
            href="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.23/dist/sweetalert2.min.css"
            rel="stylesheet"
        />
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="table-content">
                            @php $count=1; @endphp @foreach($posts as $post)
                            <tr>
                                <td>{{$count++}}</td>
                                <td>{{$post->title}}</td>
                                <td>{{$post->content}}</td>
                    ...
                    $.each(data[0].post, function (key, value) {
                        table_content += `
                            <tr>
                                ...
                                <td><a data-id="${
                                    value.id
                                }" type="button" class="btn btn-warning btn-sm" onclick="editPost(this)">Edit</a>
                                    <a id="${
                                        value.id
                                    }" onclick="removePost(this)" type="button" class="btn btn-danger btn-sm">Del</a>
                                </td>
                            </tr>
                        `;
                    });
